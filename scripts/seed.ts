  ...
  try {
    ...
    const testimonials = [
      ...
      },
      {
        personName: 'Francky SAINT-HUBERT',
        role: 'Commentateur, depuis Paris',
        quote: `Nos échanges sur l'Église, la foi, la société et les défis de notre temps ont été pour moi une véritable école. J'y ai trouvé non seulement un interlocuteur brillant, mais également un frère et un homme de Dieu dont la sagesse est constamment éclairée par les Écritures.`,
        locale: 'fr',
        isFeatured: true,
        isPublished: true,
        displayOrder: 4,
      ...
      },
      {
        personName: 'Francky SAINT-HUBERT',
        role: 'Commentateur, depuis Paris',
        quote: `Dans un monde où beaucoup critiquent l'Église sans vraiment la connaître, Samuel Louis-Jean nous invite à changer de regard. Il nous rappelle que l'Église demeure le projet de Dieu, l'Épouse de Christ et l'espérance du monde. L'aimer n'est pas une option ; c'est une responsabilité spirituelle (1 Cor. 6:19-20).

Dr. Louis-Jean, recevez ici l'expression de ma profonde admiration et de ma sincère gratitude. Merci pour votre fidélité au Seigneur, votre intégrité, votre enseignement et votre engagement sans relâche au service de l'Évangile de Jésus-Christ.
